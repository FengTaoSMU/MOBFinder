...
## Change logs
2025.12.09 The README.md and MOBFinder.py have been updated with a few modification. The conda environment file (environment.yaml) for MOBFinder has been uploaded.
